...
namespace SumoX.Report.Cri
{
    public class BarCodeITF14 : ICustomReportItem
    {
        ...
        {
            bm = new Bitmap(Barcode.DoEncode(BarcodeStandard.Type.Itf14, "1234567891011").EncodedData.AsStream());
        }

        public void DrawImage(ref Bitmap bm)
        {
            bm = new Bitmap(Barcode.DoEncode(BarcodeStandard.Type.Itf14, _Itf14Data).EncodedData.AsStream());
        }
