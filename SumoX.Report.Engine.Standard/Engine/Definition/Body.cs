...
namespace SumoX.Report.Engine.Definition
{
	...
	internal class Body : ReportLink
	{
		...
		internal int GetCurrentColumn(Runtime.Report rpt)
		{
			OInt cc = rpt.Cache.Get(this, "currentcolumn") as OInt;
			return cc == null? 0: cc.i;
		}

		internal int IncrCurrentColumn(Runtime.Report rpt)
		{
			OInt cc = rpt.Cache.Get(this, "currentcolumn") as OInt;
			if (cc == null)
			{
		...
		internal void SetCurrentColumn(Runtime.Report rpt, int col)
		{
			OInt cc = rpt.Cache.Get(this, "currentcolumn") as OInt;
			if (cc == null)
        ...
        internal void RemoveWC(Runtime.Report rpt)
        {
            if (_ReportItems == null)
                return;
