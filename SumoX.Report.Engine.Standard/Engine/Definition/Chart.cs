...
using System.IO;
using System.Xml;
using SumoX.Report.Engine.Definition.EMFConverter.EMFRecords;
...
namespace SumoX.Report.Engine.Definition
{
	...
	internal class Chart : DataRegion
	{
			...
			foreach(XmlNode xNodeLoop in xNode.ChildNodes)
			{
				...
				switch (xNodeLoop.Name)
				{
					...
					case "ChartElementOutput":
						_ChartElementOutput = Definition.ChartElementOutput.GetStyle(xNodeLoop.InnerText, OwnerReport.rl);
						break;
		...
		ChartBase RunChartBuild(Runtime.Report rpt, Row row)
		{
		...
		private Rows GetMyData(Runtime.Report rpt)
		{
