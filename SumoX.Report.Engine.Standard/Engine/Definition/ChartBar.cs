...
namespace SumoX.Report.Engine.Definition
{
	...
	internal class ChartBar: ChartBase
	{
        ...
        internal ChartBar(Runtime.Report r, Row row, Chart c, MatrixCellEntry[,] m, Expression showTooltips, Expression showTooltipsX,Expression _ToolTipYFormat, Expression _ToolTipXFormat)
		...
		void DrawPlotAreaPlain(Runtime.Report rpt, Graphics g, double min, double max)
		{
		...
		void DrawPlotAreaStacked(Runtime.Report rpt, Graphics g, double min, double max)
		{
			int barsNeeded = CategoryCount; 
			int gapsNeeded = CategoryCount * 2;
		...
		Size CategoryAxisSize(Runtime.Report rpt, Graphics g)
		{
		...
		// DrawCategoryAxis 
		void DrawCategoryAxis(Runtime.Report rpt, Graphics g, System.Drawing.Rectangle rect)
		{
			if (this.ChartDefn.CategoryAxis == null)
				return;
			Axis a = this.ChartDefn.CategoryAxis.Axis;
		...
		protected void DrawValueAxis(Runtime.Report rpt, Graphics g, double min, double max, System.Drawing.Rectangle rect, int plotTop, int plotBottom)
		{
