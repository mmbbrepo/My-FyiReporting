...
namespace SumoX.Report.Engine.Definition
{
	...
	internal class ChartBubble: ChartBase
	{
        ...
        internal ChartBubble(Runtime.Report r, Row row, Chart c, MatrixCellEntry[,] m, Expression showTooltips, Expression showTooltipsX,Expression _ToolTipYFormat, Expression _ToolTipXFormat)
            : base(r, row, c, m,showTooltips,showTooltipsX,_ToolTipYFormat, _ToolTipXFormat)
		{
		}

		override internal void Draw(Runtime.Report rpt)
		{
			CreateSizedBitmap();
        ...
        void DrawPlot(Runtime.Report rpt, Graphics g, double xmin, double xmax, double ymin, double ymax, double bmin, double bmax)
        {
            // Draw Plot area data 
        ...
        * 010308 GJL */
        void DrawLineBetweenPoints(Graphics g, Runtime.Report rpt, Brush brush, Point[] points)
        {
            DrawLineBetweenPoints(g, rpt, brush, points, 2);
        }

        void DrawLineBetweenPoints(Graphics g, Runtime.Report rpt, Brush brush, Point[] points,int intLineSize)
        {
        ...
        void DrawBubble(Runtime.Report rpt, Graphics g, Brush brush, Point p, int iRow, int iCol, double bmin, double bmax, double bv,double xv,double yv)
		{
			Pen pen=null;
        ...
        private int BubbleSize(Runtime.Report rpt, int iRow, int iCol, double minB, double maxB, double bv)
        {
            int diameter = 5;
        ...
        protected Size ValueAxisSize(Runtime.Report rpt, Graphics g, double min, double max)
        {
        ...
        protected void DrawValueAxis(Runtime.Report rpt, Graphics g, double min, double max,
        ...
        protected void DrawValueAxisGrid(Runtime.Report rpt, Graphics g, ChartGridLines gl, Point s, Point e)
        {
        ...
        protected void DrawValueAxisTick(Runtime.Report rpt, Graphics g, bool bMajor, AxisTickMarksEnum tickType, ChartGridLines gl, Point p)
        {
...
/////////////////////////
        protected void DrawCategoryAxis(Runtime.Report rpt, Graphics g, double min, double max, System.Drawing.Rectangle rect, int plotTop, int plotBottom)
        {
        ...
        protected void DrawCategoryAxisGrid(Runtime.Report rpt, Graphics g, ChartGridLines gl, Point s, Point e)
        {
            if (gl == null || !gl.ShowGridLines)
                return;
        ...
        protected void DrawCategoryAxisTick(Runtime.Report rpt, Graphics g, bool bMajor, AxisTickMarksEnum tickType, ChartGridLines gl, Point p)
        {
            if (tickType == AxisTickMarksEnum.None)
                return;
        ...
        // Calculate the size of the value axis; width is max value width + title width
        //										 height is max value height
        protected Size CategoryAxisSize(Runtime.Report rpt, Graphics g, double min, double max)
        {
            Size size = Size.Empty;
