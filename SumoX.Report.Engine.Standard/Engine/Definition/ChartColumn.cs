...
namespace SumoX.Report.Engine.Definition
{
	...
	internal class ChartColumn: ChartBase
	{
        ...
        internal ChartColumn(Runtime.Report r, Row row, Chart c, MatrixCellEntry[,] m, Expression showTooltips, Expression showTooltipsX,Expression _ToolTipYFormat, Expression _ToolTipXFormat)
		...
		void DrawPlotAreaPercentStacked(Runtime.Report rpt, Graphics g)
		{
         ...
         * 06122007AJM
         */
		void DrawPlotAreaPlain(Runtime.Report rpt, Graphics g, double max, double min, double ScaleFactor)
		{
		...
		void DrawPlotAreaStacked(Runtime.Report rpt, Graphics g, double max, double min)
		{
			int barsNeeded = CategoryCount; 
			int gapsNeeded = CategoryCount * 2;
		...
		protected Size CategoryAxisSize(Runtime.Report rpt, Graphics g)
		{
        ...
        protected void DrawCategoryAxis(Runtime.Report rpt, Graphics g, System.Drawing.Rectangle rect, int plotTop, int maxWidth)
		{
			if (this.ChartDefn.CategoryAxis == null)
				return;
			Axis a = this.ChartDefn.CategoryAxis.Axis;
		...
		void DrawColumnBar(Runtime.Report rpt, Graphics g, Brush brush, System.Drawing.Rectangle rect, int iRow, int iCol)
		{
			if (rect.Height <= 0)
				return;
        ...
        protected void Draw2ndValueAxis(Runtime.Report rpt, Graphics g, double min, double max,
