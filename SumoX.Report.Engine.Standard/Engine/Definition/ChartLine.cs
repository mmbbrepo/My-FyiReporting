...
namespace SumoX.Report.Engine.Definition
{
	...
	internal class ChartLine: ChartColumn
	{
        ...
        internal ChartLine(Runtime.Report r, Row row, Chart c, MatrixCellEntry[,] m, Expression showTooltips, Expression showTooltipsX,Expression _ToolTipYFormat, Expression _ToolTipXFormat)
		...
		void DrawPlotAreaArea(Runtime.Report rpt, Graphics g, double min, double max)
		{
			// Draw Plot area data 
		...
		void DrawPlotAreaAreaPercentStacked(Runtime.Report rpt, Graphics g)
		{
		...
		void DrawPlotAreaAreaStacked(Runtime.Report rpt, Graphics g, double min, double max)
		{
			// Draw Plot area data 
			int maxPointHeight = (int) Layout.PlotArea.Height;	
			double widthCat = ((double) (Layout.PlotArea.Width) / (CategoryCount-1));
		...
		void DrawPlotAreaLine(Runtime.Report rpt, Graphics g, double min, double max)
		{
			// Draw Plot area data 
			int maxPointHeight = (int) Layout.PlotArea.Height;	
		...
		void DrawLinePoint(Runtime.Report rpt, Graphics g, Brush brush, ChartMarkerEnum marker, Point p, int iRow, int iCol)
		{
			Pen pen=null;
			try
			{
