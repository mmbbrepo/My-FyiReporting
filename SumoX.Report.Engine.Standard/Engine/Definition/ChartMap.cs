...
namespace SumoX.Report.Engine.Definition
{
	...
	internal class ChartMap: ChartBase
	{
        ...
        internal ChartMap(Runtime.Report r, Row row, Chart c, MatrixCellEntry[,] m, Expression showTooltips, Expression showTooltipsX, Expression _ToolTipYFormat, Expression _ToolTipXFormat)
        ...
        private void DrawMap(Runtime.Report rpt, Graphics g, string mapfile, double max, double min)
        {
