...
namespace SumoX.Report.Engine.Definition
{
	...
	internal class ChartPie: ChartBase
	{
        ...
        internal ChartPie(Runtime.Report r, Row row, Chart c, MatrixCellEntry[,] m, Expression showTooltips, Expression showTooltipsX,Expression _ToolTipYFormat, Expression _ToolTipXFormat)
		...
		void DrawPlotAreaDoughnut(Runtime.Report rpt, Graphics g)
		{
			// Draw Plot area data
		...
		void DrawPlotAreaPie(Runtime.Report rpt, Graphics g)
		{
		...
		// DrawCategoryAxis 
		protected void DrawCategoryAxis(Runtime.Report rpt, Graphics g, System.Drawing.Rectangle rect)
		{
			if (this.ChartDefn.CategoryAxis == null)
				return;
			Axis a = this.ChartDefn.CategoryAxis.Axis;
		...
		void DrawPie(Graphics g, Runtime.Report rpt, Brush brush, System.Drawing.Rectangle rect, int iRow, int iCol, float startAngle, float endAngle)
		{
