...
//						tsw.Close();
		...
		internal object Load(Runtime.Report rpt)
		{
		...
		internal object Instance(Runtime.Report rpt)
		{
    ...
    public class CodeReport
    {
        ...
        public CodeReport(Runtime.Report report)
        {
    ...
    {
        private readonly Runtime.Report report;

        public CodeParameters(Runtime.Report report)
        {
            this.report = report;
        }
    ...
    public class CodeUser
    {
        ...
        public CodeUser(Runtime.Report report)
        {
            this.report = report;
        }
...
/// </summary>
    public class CodeGlobals
    {
        ...
        public CodeGlobals(Runtime.Report report)
        {
            this.report = report;
        }
