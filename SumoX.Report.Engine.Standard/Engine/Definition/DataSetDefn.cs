...
namespace SumoX.Report.Engine.Definition
{
	...
	internal class DataSetDefn : ReportLink
	{
		...
		internal bool GetData(Runtime.Report rpt)
		{
		...
		private string GetDataFile(Runtime.Report rpt, string file)
		{
		...
		internal void SetData(Runtime.Report rpt, IDataReader dr)
		{
			Query.SetData(rpt, dr, _Fields, _Filters);		// get the data (and apply the filters
		}

		internal void SetData(Runtime.Report rpt, DataTable dt)
		{
			Query.SetData(rpt, dt, _Fields, _Filters);
		}

		internal void SetData(Runtime.Report rpt, XmlDocument xmlDoc)
		{
			Query.SetData(rpt, xmlDoc, _Fields, _Filters);
		}

		internal void SetData(Runtime.Report rpt, IEnumerable ie)
		{
