...
namespace SumoX.Report.Engine.Definition
{
	...
	internal class DataSourceDefn : ReportLink
	{
		...
		internal bool IsConnected(Runtime.Report rpt)
		{
		...
		internal bool ConnectDataSource(Runtime.Report rpt)
		{
		...
		void ConnectDataSourceReference(Runtime.Report rpt)
		{
			if (_ConnectionProperties != null)
				return;
			...
			try
			{
				...
				string xml = Definition.DataSourceReference.Retrieve(file, pswd);
		...
		internal bool IsUserConnection(Runtime.Report rpt)
		{
			if (rpt == null)
				return false;
		...
		internal void SetUserConnection(Runtime.Report rpt, IDbConnection cn)
		{
            if (cn == null)
		...
		private void SetSysConnection(Runtime.Report rpt, IDbConnection cn)
		{
			if (rpt == null)
				_ParseConnection = cn;
			else if (cn == null)
		...
		internal IDbConnection GetConnection(Runtime.Report rpt)
		{
			IDbConnection cn;
		...
		internal void CleanUp(Runtime.Report rpt)
		{
		...
		internal IDbConnection SqlConnect(Runtime.Report rpt)
		{
