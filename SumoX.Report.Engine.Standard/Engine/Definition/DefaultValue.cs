...
namespace SumoX.Report.Engine.Definition
{
	...
	internal class DefaultValue : ReportLink
	{
		...
		internal object[] GetValue(Runtime.Report rpt)
		{
			if (_Values != null)
		...
		internal object[] ValuesCalc(Runtime.Report rpt)
		{
			if (_Values == null)
				return null;
		...
		private object[] GetDataValues(Runtime.Report rpt)
		{
			return rpt.Cache.Get(this, "datavalues") as object[];
		}

		private void SetDataValues(Runtime.Report rpt, object[] vs)
		{
			if (vs == null)
