...
namespace SumoX.Report.Engine.Definition
{
	...
	internal class DynamicExpression: IExpr
	{
		...
		internal DynamicExpression(Runtime.Report rpt, ReportLink p, string expr, Row row)
		{
			_Source=expr;
			_Expr = null;
            _rl = p;
		...
		internal TypeCode DoParse(Runtime.Report rpt)
		{
		...
		private void ReportError(Runtime.Report rpt, int severity, string err)
		{
