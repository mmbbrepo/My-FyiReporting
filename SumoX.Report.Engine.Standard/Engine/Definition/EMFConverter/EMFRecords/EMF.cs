...
using SumoX.Report.Engine.Definition.EMFConverter.EMFRecords.EMFDrawingRecords;
using SumoX.Report.Engine.Definition.EMFConverter.EMFRecords.EMFTransform;
using SumoX.Report.Engine.Runtime.PageItems;

namespace SumoX.Report.Engine.Definition.EMFConverter.EMFRecords
{
    public class EMF
    {
