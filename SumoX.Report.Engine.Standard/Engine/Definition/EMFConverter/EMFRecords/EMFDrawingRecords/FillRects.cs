...
using System.IO;
using SumoX.Report.Engine.Definition.EMFConverter.EMFRecords.EMFObjects;
using SumoX.Report.Engine.Runtime;
using SumoX.Report.Engine.Runtime.PageItems;

namespace SumoX.Report.Engine.Definition.EMFConverter.EMFRecords.EMFDrawingRecords
{       
