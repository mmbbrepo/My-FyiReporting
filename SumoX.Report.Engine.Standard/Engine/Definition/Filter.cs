...
namespace SumoX.Report.Engine.Definition
{
	...
	internal class Filter : ReportLink
	{
			...
			foreach(XmlNode xNodeLoop in xNode.ChildNodes)
			{
				...
				switch (xNodeLoop.Name)
				{
					case "FilterExpression":
						...
						break;
					case "Operator":
						_FilterOperator = Definition.FilterOperator.GetStyle(xNodeLoop.InnerText);
		...
		internal bool Apply(Runtime.Report rpt, Row datarow)
		{
		...
		internal void Apply(Runtime.Report rpt, Rows data)
		{
		...
		private void ApplySingleRowFilter(Runtime.Report rpt, Rows data)
		{
		...
		private void ApplyTopBottomFilter(Runtime.Report rpt, Rows data)
		{
