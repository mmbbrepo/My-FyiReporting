...
namespace SumoX.Report.Engine.Definition
{
	...
	public class RDLParser
	{
		...
		Runtime.Report _Report=null;	// The report; complete if bPassed true
		...
		public Runtime.Report Parse()
		{
			return Parse(0);
		}
		
		internal Runtime.Report Parse(int oc)
			{
