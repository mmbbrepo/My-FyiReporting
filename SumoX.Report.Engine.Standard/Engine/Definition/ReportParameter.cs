...
namespace SumoX.Report.Engine.Definition
{
	...
	internal class ReportParameter : ReportLink
	{
		...
		internal object GetRuntimeValue(Runtime.Report rpt)
		{
        ...
        internal ArrayList GetRuntimeValues(Runtime.Report rpt)
        {
		...
		internal void SetRuntimeValue(Runtime.Report rpt, object v)
		{
            if (this.MultiValue)
        ...
        internal void SetRuntimeValues(Runtime.Report rpt, ArrayList vs)
        {
            if (!this.MultiValue)
...
/// </summary>
	public class UserReportParameter
	{
		...
		internal UserReportParameter(Runtime.Report rpt, ReportParameter rp)
		{
			_rpt = rpt;
			_rp = rp;
		}
