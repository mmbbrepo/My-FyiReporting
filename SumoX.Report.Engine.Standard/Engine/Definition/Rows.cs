...
namespace SumoX.Report.Engine.Definition
{
    ...
    internal class Rows : System.Collections.Generic.IComparer<Row>, IDisposable
	{
		...
		internal Rows(Runtime.Report rpt)
		{
			_Rpt = rpt;
			_SortBy = null;
			_CurrentGroups = null;
		...
		internal Rows(Runtime.Report rpt, Rows r, int start, int end, BitArray ba)
		{
			_Rpt = rpt;
			_SortBy = null;
			_CurrentGroups = null;
		...
		internal Rows(Runtime.Report rpt, Rows r)
		{
			_Rpt = rpt;
			_SortBy = null;
			_CurrentGroups = null;
        ...
        static internal Rows CreateOneRow(Runtime.Report rpt)
        {
		...
		internal Rows(Runtime.Report rpt, TableGroups tg, Grouping g, Sorting s)
		{
			_Rpt = rpt;
		...
		internal Runtime.Report Report
		{
