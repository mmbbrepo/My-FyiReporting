...
namespace SumoX.Report.Engine.Definition
{
	...
	internal class Style : ReportLink
	{
		...
		internal void DrawBackground(Runtime.Report rpt, Graphics g, Row r, System.Drawing.Rectangle rect)
		{
		...
		internal void DrawBackgroundCircle(Runtime.Report rpt, Graphics g, Row r, System.Drawing.Rectangle rect)
		{
		...
		internal void DrawBorder(Runtime.Report rpt, Graphics g, Row r, System.Drawing.Rectangle rect)
		{
		...
		internal void DrawStyleLine(Runtime.Report rpt, Graphics g, Row r, Point s, Point e)
		{
			Pen p = null;
			Brush b = null;
			try
		...
		//  information
		internal void DrawString(Runtime.Report rpt, Graphics g, object o, TypeCode tc, Row r, System.Drawing.Rectangle rect)
		{
		...
		//  information
		internal Size MeasureString(Runtime.Report rpt, Graphics g, object o, TypeCode tc, Row r, int maxWidth)
		{
			Font drawFont=null;				// Font we'll draw with
			StringFormat drawFormat=null;	// StringFormat we'll draw with
			string s;						// the string to draw
		...
		static internal Size MeasureStringDefaults(Runtime.Report rpt, Graphics g, object o, TypeCode tc, Row r, int maxWidth)
		{
			Font drawFont=null;				// Font we'll draw with
			StringFormat drawFormat=null;	// StringFormat we'll draw with
			string s;						// the string to draw
		...
		internal Brush GetBrush(Runtime.Report rpt, Row r)
		{
			Brush drawBrush;
		...
		internal Font GetFont(Runtime.Report rpt, Row r)
		{
        ...
        internal StringFormat GetStringFormat(Runtime.Report rpt, Row r)
        {
            return GetStringFormat(rpt, r, StringAlignment.Center);
        }

		internal StringFormat GetStringFormat(Runtime.Report rpt, Row r, StringAlignment defTextAlign)
		{
			// Set format of string.
		...
		internal string GetCSS(Runtime.Report rpt, Row row, bool bDefaults)
		{
		...
		internal StyleInfo GetStyleInfo(Runtime.Report rpt, Row r)
		{
			WorkClass wc = GetWC(rpt);
		...
		static internal string GetFormatedString(Runtime.Report rpt, Style s, Row row, object o, TypeCode tc)
		{
			string t = null;
			if (o == null)
				return "";
		...
		internal System.Drawing.Rectangle PaddingAdjust(Runtime.Report rpt, Row r, System.Drawing.Rectangle rect, bool bAddIn)
		{
		...
		internal Color EvalBackgroundColor(Runtime.Report rpt, Row row)
		{
			if (_BackgroundColor == null)
		...
		internal BackgroundGradientTypeEnum EvalBackgroundGradientType(Runtime.Report rpt, Row r)
		{
			if (_BackgroundGradientType == null)
		...
		internal Color EvalBackgroundGradientEndColor(Runtime.Report rpt, Row r)
		{
			if (_BackgroundGradientEndColor == null)
				return System.Drawing.Color.Empty;
		...
		internal bool IsFontItalic(Runtime.Report rpt, Row r)
		{
		...
		internal FontStyleEnum EvalFontStyle(Runtime.Report rpt, Row row)
		{
			if (_FontStyle == null)
		...
		internal string EvalFontFamily(Runtime.Report rpt, Row row)
		{
			if (_FontFamily == null)
				return "Arial";
		...
		internal float EvalFontSize(Runtime.Report rpt, Row row)
		{
			if (_FontSize == null)
				return 10;
		...
		internal FontWeightEnum EvalFontWeight(Runtime.Report rpt, Row row)
		{
			if (_FontWeight == null)
		...
		internal bool IsFontBold(Runtime.Report rpt, Row r)
		{
			if (this.FontWeight == null)
				return false;
        ...
        internal string EvalFormat(Runtime.Report rpt, Row row)
        {
            if (_Format == null)
                return "General";
		...
		internal TextDecorationEnum EvalTextDecoration(Runtime.Report rpt, Row r)
		{
			if (_TextDecoration == null)
		...
		internal TextAlignEnum EvalTextAlign(Runtime.Report rpt, Row row)
		{
			if (_TextAlign == null)
		...
		internal VerticalAlignEnum EvalVerticalAlign(Runtime.Report rpt, Row row)
		{
			if (_VerticalAlign == null)
		...
		internal Color EvalColor(Runtime.Report rpt, Row row)
		{
			if (_Color == null)
		...
		internal float EvalPaddingLeft(Runtime.Report rpt, Row row)
		{
			if (_PaddingLeft == null)
				return 0;
		...
		internal int EvalPaddingLeftPx(Runtime.Report rpt, Row row)
		{
			if (_PaddingLeft == null)
				return 0;
		...
		internal float EvalPaddingRight(Runtime.Report rpt, Row row)
		{
			if (_PaddingRight == null)
				return 0;
		...
		internal int EvalPaddingRightPx(Runtime.Report rpt, Row row)
		{
			if (_PaddingRight == null)
				return 0;
		...
		internal float EvalPaddingTop(Runtime.Report rpt, Row row)
		{
			if (_PaddingTop == null)
				return 0;
		...
		internal int EvalPaddingTopPx(Runtime.Report rpt, Row row)
		{
			if (_PaddingTop == null)
				return 0;
		...
		internal float EvalPaddingBottom(Runtime.Report rpt, Row row)
		{
			if (_PaddingBottom == null)
				return 0;
		...
		internal int EvalPaddingBottomPx(Runtime.Report rpt, Row row)
		{
			if (_PaddingBottom == null)
				return 0;
		...
		internal float EvalLineHeight(Runtime.Report rpt, Row r)
		{
			if (_LineHeight == null)
				return float.NaN;
		...
		internal DirectionEnum EvalDirection(Runtime.Report rpt, Row r)
		{
			if (_Direction == null)
		...
		internal WritingModeEnum EvalWritingMode(Runtime.Report rpt, Row r)
		{
			if (_WritingMode == null)
		...
		internal string EvalLanguage(Runtime.Report rpt, Row r)
		{
			if (_Language == null)
		...
		internal UnicodeBiDirectionalEnum EvalUnicodeBiDirectional(Runtime.Report rpt, Row r)
		{
			if (_UnicodeBiDirectional == null)
		...
		internal CalendarEnum EvalCalendar(Runtime.Report rpt, Row r)
		{
			if (_Calendar == null)
		...
		internal string EvalNumeralLanguage(Runtime.Report rpt, Row r)
		{
			if (_NumeralLanguage == null)
		...
		internal int EvalNumeralVariant(Runtime.Report rpt, Row r)
		{
			if (_NumeralVariant == null)
				return 1;
		...
		private WorkClass GetWC(Runtime.Report rpt)
		{
		...
		private void RemoveWC(Runtime.Report rpt)
		{
