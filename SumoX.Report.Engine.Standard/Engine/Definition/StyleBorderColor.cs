...
namespace SumoX.Report.Engine.Definition
{
	...
	internal class StyleBorderColor : ReportLink
	{
		...
		internal Color EvalDefault(Runtime.Report rpt, Row r)
		{
			if (_Default == null)
		...
		internal Color EvalLeft(Runtime.Report rpt, Row r)
		{
			if (_Left == null)
		...
		internal Color EvalRight(Runtime.Report rpt, Row r)
		{
			if (_Right == null)
				return EvalDefault(rpt, r);
		...
		internal Color EvalTop(Runtime.Report rpt, Row r)
		{
			if (_Top == null)
				return EvalDefault(rpt, r);
		...
		internal Color EvalBottom(Runtime.Report rpt, Row r)
		{
			if (_Bottom == null)
				return EvalDefault(rpt, r);
