...
namespace SumoX.Report.Engine.Definition
{
	...
	internal class StyleBorderStyle : ReportLink
	{
		...
		internal BorderStyleEnum EvalDefault(Runtime.Report rpt, Row r)
		{
			if (_Default == null)
		...
		internal BorderStyleEnum EvalLeft(Runtime.Report rpt, Row r)
		{
			if (_Left == null)
		...
		internal BorderStyleEnum EvalRight(Runtime.Report rpt, Row r)
		{
			if (_Right == null)
				return EvalDefault(rpt, r);
		...
		internal BorderStyleEnum EvalTop(Runtime.Report rpt, Row r)
		{
			if (_Top == null)
				return EvalDefault(rpt, r);
		...
		internal BorderStyleEnum EvalBottom(Runtime.Report rpt, Row r)
		{
			if (_Bottom == null)
				return EvalDefault(rpt, r);
