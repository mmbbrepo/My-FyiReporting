...
namespace SumoX.Report.Engine.Definition
{
	...
	internal class StyleBorderWidth : ReportLink
	{
		...
		internal float EvalDefault(Runtime.Report rpt, Row r)	// return points
		{
			if (_Default == null)
				return 1;
		...
		internal float EvalLeft(Runtime.Report rpt, Row r)	// return points
		{
			if (_Left == null)
		...
		internal float EvalRight(Runtime.Report rpt, Row r)	// return points
		{
			if (_Right == null)
				return EvalDefault(rpt, r);
		...
		internal float EvalTop(Runtime.Report rpt, Row r)	// return points
		{
			if (_Top == null)
				return EvalDefault(rpt, r);
		...
		internal float EvalBottom(Runtime.Report rpt, Row r)	// return points
		{
			if (_Bottom == null)
				return EvalDefault(rpt, r);
