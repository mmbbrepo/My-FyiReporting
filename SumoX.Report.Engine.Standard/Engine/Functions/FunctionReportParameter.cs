...
namespace SumoX.Report.Engine.Functions
{
	...
	internal class FunctionReportParameter : IExpr
	{
		...
		public virtual object Evaluate(Runtime.Report rpt, Row row)
		{
            return this.p.MultiValue? EvaluateMV(rpt, row): p.GetRuntimeValue(rpt);
		}

        private object EvaluateMV(Runtime.Report rpt, Row row)
        {
		...
		public virtual double EvaluateDouble(Runtime.Report rpt, Row row)
		{
		...
		public virtual decimal EvaluateDecimal(Runtime.Report rpt, Row row)
		{
            object rtv = Evaluate(rpt, row);
			if (rtv == null)
        ...
        public virtual int EvaluateInt32(Runtime.Report rpt, Row row)
        {
            object rtv = Evaluate(rpt, row);
            if (rtv == null)
                return int.MinValue;
		...
		public virtual string EvaluateString(Runtime.Report rpt, Row row)
		{
...
//            object rtv = Evaluate(rpt, row);
		...
		public virtual DateTime EvaluateDateTime(Runtime.Report rpt, Row row)
		{
            object rtv = Evaluate(rpt, row);
			if (rtv == null)
		...
		public virtual bool EvaluateBoolean(Runtime.Report rpt, Row row)
		{
            object rtv = Evaluate(rpt, row);
