...
using BorderStyleEnum = SumoX.Report.Engine.Definition.BorderStyleEnum;
	...
	public class ExcelCellStyle
	{
		...
		public XSSFColor FontColor {
			get {
                ...
                return new XSSFColor(fontColor.IsEmpty ? new byte[] { 0, 0, 0 } : new byte[]{fontColor.R,fontColor.G,fontColor.B});
			}
		}
		...
		public XSSFColor BackgroundColor {
			get {
                return new XSSFColor(backgroundColor.IsEmpty ?  new byte[] { 255, 255, 255 }  : new byte[] { backgroundColor.R, backgroundColor.G, backgroundColor.B } );
			}
		}
		...
		public XSSFColor BorderTopColor {
			get {
                return new XSSFColor(borderTopColor.IsEmpty ? new byte[] { 0, 0, 0 }  : new byte[] { borderTopColor.R, borderTopColor.G, borderTopColor.B } );
			}
		}
		...
		public XSSFColor BorderRightColor {
			get {
                return new XSSFColor(borderRightColor.IsEmpty ?new byte[] { 0, 0, 0 } : new byte[] { borderRightColor.R, borderRightColor.G, borderRightColor.B });
			}
		}
		...
		public XSSFColor BorderBottomColor {
			get {
				return new XSSFColor(borderBottomColor.IsEmpty ? new byte[] { 0, 0, 0 } : new byte[] { borderBottomColor.R, borderBottomColor.G, borderBottomColor.B });
			}
		}
		...
		public XSSFColor BorderLeftColor {
			get {
				return new XSSFColor(borderLeftColor.IsEmpty ? new byte[] { 0, 0, 0 } : new byte[] { borderLeftColor.R, borderLeftColor.G, borderLeftColor.B });
			}
		}
