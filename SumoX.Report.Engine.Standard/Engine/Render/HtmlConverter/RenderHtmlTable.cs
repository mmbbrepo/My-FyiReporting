...
namespace SumoX.Report.Engine.Render.HtmlConverter
{
 ...
 //       Stack<string> _Container;   // container for body/list/rectangle/ ...
		...
		public RenderHtmlTable(Runtime.Report rep, IStreamGen sg)
		{
			r = rep;
