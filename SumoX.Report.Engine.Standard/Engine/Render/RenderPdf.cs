...
using SumoX.Report.Engine.Utility;
using Header = SumoX.Report.Engine.Definition.Header;
using Image = SumoX.Report.Engine.Definition.Image;
using List = SumoX.Report.Engine.Definition.List;
using Rectangle = SumoX.Report.Engine.Definition.Rectangle;
using Row = SumoX.Report.Engine.Definition.Row;
using Table = SumoX.Report.Engine.Definition.Table;
...
namespace SumoX.Report.Engine.Render
{
    ...
    internal class RenderPdf : IPresent
    {
        ...
        public RenderPdf(Runtime.Report rep, IStreamGen sg)
        {
            r = rep;
            tw = sg.GetStream();
        }

        public Runtime.Report Report()
        {
            return r;
        }
        ...
        public void Image(Image i, Row r, string mimeType, Stream ior)
        {
        }
